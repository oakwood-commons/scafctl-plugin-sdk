...
var file_plugin_proto_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 74)
var file_plugin_proto_plugin_proto_goTypes = []any{
	...
	nil,                                   // 73: plugin.ConfigureProviderRequest.SettingsEntry
	nil,                                   // 74: plugin.ConfigureAuthHandlerRequest.SettingsEntry
}
var file_plugin_proto_plugin_proto_depIdxs = []int32{
	...
	73, // 12: plugin.ConfigureProviderRequest.settings:type_name -> plugin.ConfigureProviderRequest.SettingsEntry
	20, // 13: plugin.ConfigureProviderResponse.diagnostics:type_name -> plugin.Diagnostic
	21, // 14: plugin.ExecuteProviderStreamChunk.result:type_name -> plugin.ExecuteProviderResponse
	0,  // 15: plugin.Diagnostic.severity:type_name -> plugin.Diagnostic.Severity
	20, // 16: plugin.ExecuteProviderResponse.diagnostics:type_name -> plugin.Diagnostic
	20, // 17: plugin.DescribeWhatIfResponse.diagnostics:type_name -> plugin.Diagnostic
	20, // 18: plugin.ExtractDependenciesResponse.diagnostics:type_name -> plugin.Diagnostic
	30, // 19: plugin.GetAuthHandlersResponse.handlers:type_name -> plugin.AuthHandlerInfo
	33, // 20: plugin.LoginStreamMessage.device_code_prompt:type_name -> plugin.DeviceCodePrompt
	34, // 21: plugin.LoginStreamMessage.result:type_name -> plugin.LoginResult
	35, // 22: plugin.LoginResult.claims:type_name -> plugin.Claims
	35, // 23: plugin.GetStatusResponse.claims:type_name -> plugin.Claims
	44, // 24: plugin.ListCachedTokensResponse.tokens:type_name -> plugin.CachedTokenInfo
	74, // 25: plugin.ConfigureAuthHandlerRequest.settings:type_name -> plugin.ConfigureAuthHandlerRequest.SettingsEntry
	20, // 26: plugin.ConfigureAuthHandlerResponse.diagnostics:type_name -> plugin.Diagnostic
	53, // 27: plugin.DetectAvailableFlowsResponse.flows:type_name -> plugin.FlowAvailability
	35, // 28: plugin.GetAuthIdentityResponse.claims:type_name -> plugin.Claims
	12, // 29: plugin.ProviderDescriptor.OutputSchemasEntry.value:type_name -> plugin.Schema
	13, // 30: plugin.Schema.ParametersEntry.value:type_name -> plugin.Parameter
	3,  // 31: plugin.PluginService.GetProviders:input_type -> plugin.GetProvidersRequest
	5,  // 32: plugin.PluginService.GetProviderDescriptor:input_type -> plugin.GetProviderDescriptorRequest
	15, // 33: plugin.PluginService.ConfigureProvider:input_type -> plugin.ConfigureProviderRequest
	14, // 34: plugin.PluginService.ExecuteProvider:input_type -> plugin.ExecuteProviderRequest
	14, // 35: plugin.PluginService.ExecuteProviderStream:input_type -> plugin.ExecuteProviderRequest
	22, // 36: plugin.PluginService.DescribeWhatIf:input_type -> plugin.DescribeWhatIfRequest
	24, // 37: plugin.PluginService.ExtractDependencies:input_type -> plugin.ExtractDependenciesRequest
	26, // 38: plugin.PluginService.StopProvider:input_type -> plugin.StopProviderRequest
	54, // 39: plugin.HostService.GetSecret:input_type -> plugin.GetSecretRequest
	56, // 40: plugin.HostService.SetSecret:input_type -> plugin.SetSecretRequest
	58, // 41: plugin.HostService.DeleteSecret:input_type -> plugin.DeleteSecretRequest
	60, // 42: plugin.HostService.ListSecrets:input_type -> plugin.ListSecretsRequest
	62, // 43: plugin.HostService.GetAuthIdentity:input_type -> plugin.GetAuthIdentityRequest
	64, // 44: plugin.HostService.ListAuthHandlers:input_type -> plugin.ListAuthHandlersRequest
	66, // 45: plugin.HostService.GetAuthToken:input_type -> plugin.GetAuthTokenRequest
	68, // 46: plugin.HostService.GetAuthGroups:input_type -> plugin.GetAuthGroupsRequest
	28, // 47: plugin.AuthHandlerService.GetAuthHandlers:input_type -> plugin.GetAuthHandlersRequest
	47, // 48: plugin.AuthHandlerService.ConfigureAuthHandler:input_type -> plugin.ConfigureAuthHandlerRequest
	31, // 49: plugin.AuthHandlerService.Login:input_type -> plugin.LoginRequest
	36, // 50: plugin.AuthHandlerService.Logout:input_type -> plugin.LogoutRequest
	38, // 51: plugin.AuthHandlerService.GetStatus:input_type -> plugin.GetStatusRequest
	40, // 52: plugin.AuthHandlerService.GetToken:input_type -> plugin.GetTokenRequest
	42, // 53: plugin.AuthHandlerService.ListCachedTokens:input_type -> plugin.ListCachedTokensRequest
	45, // 54: plugin.AuthHandlerService.PurgeExpiredTokens:input_type -> plugin.PurgeExpiredTokensRequest
	49, // 55: plugin.AuthHandlerService.StopAuthHandler:input_type -> plugin.StopAuthHandlerRequest
	51, // 56: plugin.AuthHandlerService.DetectAvailableFlows:input_type -> plugin.DetectAvailableFlowsRequest
	1,  // 57: plugin.AuthHandlerService.ActivateServerMode:input_type -> plugin.ActivateServerModeRequest
	4,  // 58: plugin.PluginService.GetProviders:output_type -> plugin.GetProvidersResponse
	6,  // 59: plugin.PluginService.GetProviderDescriptor:output_type -> plugin.GetProviderDescriptorResponse
	16, // 60: plugin.PluginService.ConfigureProvider:output_type -> plugin.ConfigureProviderResponse
	21, // 61: plugin.PluginService.ExecuteProvider:output_type -> plugin.ExecuteProviderResponse
	19, // 62: plugin.PluginService.ExecuteProviderStream:output_type -> plugin.ExecuteProviderStreamChunk
	23, // 63: plugin.PluginService.DescribeWhatIf:output_type -> plugin.DescribeWhatIfResponse
	25, // 64: plugin.PluginService.ExtractDependencies:output_type -> plugin.ExtractDependenciesResponse
	27, // 65: plugin.PluginService.StopProvider:output_type -> plugin.StopProviderResponse
	55, // 66: plugin.HostService.GetSecret:output_type -> plugin.GetSecretResponse
	57, // 67: plugin.HostService.SetSecret:output_type -> plugin.SetSecretResponse
	59, // 68: plugin.HostService.DeleteSecret:output_type -> plugin.DeleteSecretResponse
	61, // 69: plugin.HostService.ListSecrets:output_type -> plugin.ListSecretsResponse
	63, // 70: plugin.HostService.GetAuthIdentity:output_type -> plugin.GetAuthIdentityResponse
	65, // 71: plugin.HostService.ListAuthHandlers:output_type -> plugin.ListAuthHandlersResponse
	67, // 72: plugin.HostService.GetAuthToken:output_type -> plugin.GetAuthTokenResponse
	69, // 73: plugin.HostService.GetAuthGroups:output_type -> plugin.GetAuthGroupsResponse
	29, // 74: plugin.AuthHandlerService.GetAuthHandlers:output_type -> plugin.GetAuthHandlersResponse
	48, // 75: plugin.AuthHandlerService.ConfigureAuthHandler:output_type -> plugin.ConfigureAuthHandlerResponse
	32, // 76: plugin.AuthHandlerService.Login:output_type -> plugin.LoginStreamMessage
	37, // 77: plugin.AuthHandlerService.Logout:output_type -> plugin.LogoutResponse
	39, // 78: plugin.AuthHandlerService.GetStatus:output_type -> plugin.GetStatusResponse
	41, // 79: plugin.AuthHandlerService.GetToken:output_type -> plugin.GetTokenResponse
	43, // 80: plugin.AuthHandlerService.ListCachedTokens:output_type -> plugin.ListCachedTokensResponse
	46, // 81: plugin.AuthHandlerService.PurgeExpiredTokens:output_type -> plugin.PurgeExpiredTokensResponse
	50, // 82: plugin.AuthHandlerService.StopAuthHandler:output_type -> plugin.StopAuthHandlerResponse
	52, // 83: plugin.AuthHandlerService.DetectAvailableFlows:output_type -> plugin.DetectAvailableFlowsResponse
	2,  // 84: plugin.AuthHandlerService.ActivateServerMode:output_type -> plugin.ActivateServerModeResponse
