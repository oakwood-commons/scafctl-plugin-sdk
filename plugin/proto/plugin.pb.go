...
func (Diagnostic_Severity) EnumDescriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{19, 0}
}

type ActivateServerModeRequest struct {
...
func (x *ActivateServerModeRequest) Reset() {
	*x = ActivateServerModeRequest{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActivateServerModeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivateServerModeRequest) ProtoMessage() {}

func (x *ActivateServerModeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_plugin_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ActivateServerModeRequest.ProtoReflect.Descriptor instead.
func (*ActivateServerModeRequest) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{0}
}

func (x *ActivateServerModeRequest) GetSettings() []byte {
	if x != nil {
		return x.Settings
	}
	return nil
...
type ActivateServerModeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ActivateServerModeResponse) Reset() {
	*x = ActivateServerModeResponse{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActivateServerModeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivateServerModeResponse) ProtoMessage() {}

func (x *ActivateServerModeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_plugin_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivateServerModeResponse.ProtoReflect.Descriptor instead.
func (*ActivateServerModeResponse) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{1}
}

func (x *ActivateServerModeResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type ProviderDescriptor struct {
	...
	Operations             []*OperationDescriptor `protobuf:"bytes,23,rep,name=operations,proto3" json:"operations,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ProviderDescriptor) GetOperations() []*OperationDescriptor {
	if x != nil {
		return x.Operations
	}
	return nil
...
type OperationDescriptor struct {
	...
	IsWrite            bool                   `protobuf:"varint,5,opt,name=is_write,json=isWrite,proto3" json:"is_write,omitempty"`
	InputSchema        []byte                 `protobuf:"bytes,6,opt,name=input_schema,json=inputSchema,proto3" json:"input_schema,omitempty"`
	OutputSchema       []byte                 `protobuf:"bytes,7,opt,name=output_schema,json=outputSchema,proto3" json:"output_schema,omitempty"`
...
func (x *OperationDescriptor) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *OperationDescriptor) GetCapabilities() []string {
	if x != nil {
		return x.Capabilities
	}
	return nil
...
func (x *OperationDescriptor) GetIsWrite() bool {
	if x != nil {
		return x.IsWrite
	}
	return false
...
func (x *OperationDescriptor) GetInputSchema() []byte {
	if x != nil {
...
func (x *OperationDescriptor) GetOutputSchema() []byte {
	if x != nil {
...
func (x *OperationDescriptor) GetExamples() []*Example {
	if x != nil {
		return x.Examples
	}
	return nil
...
func (x *OperationDescriptor) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *OperationDescriptor) GetDeprecated() bool {
	if x != nil {
		return x.Deprecated
	}
	return false
...
func (x *OperationDescriptor) GetDeprecationMessage() string {
	if x != nil {
...
type ExecuteProviderRequest struct {
	...
	// settings carries the full effective per-execution host settings. It
	// mirrors ConfigureProviderRequest.settings but is delivered per execution so
	// pooled (long-lived) hosts can supply per-solution values that cannot be sent
	// through the one-time ConfigureProvider RPC. The SDK merges these over the
	// configure-time settings. Additive: older hosts omit it.
	Settings      map[string][]byte `protobuf:"bytes,14,rep,name=settings,proto3" json:"settings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecuteProviderRequest) GetSettings() map[string][]byte {
	if x != nil {
		return x.Settings
	}
	return nil
...
type SolutionMeta struct {
	...
	// catalog reference, or URL). Additive so pool-mode and per-call outputs match.
...
func (x *SolutionMeta) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *LogoutRequest) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
func (x *GetTokenRequest) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
func (x *GetTokenRequest) GetServerContext() string {
	if x != nil {
...
func (x *GetTokenRequest) GetCaller() string {
	if x != nil {
		return x.Caller
	}
	return ""
...
func (x *ListCachedTokensRequest) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
func (x *PurgeExpiredTokensRequest) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
type DetectAvailableFlowsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HandlerName   string                 `protobuf:"bytes,1,opt,name=handler_name,json=handlerName,proto3" json:"handler_name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *DetectAvailableFlowsRequest) Reset() {
	*x = DetectAvailableFlowsRequest{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DetectAvailableFlowsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DetectAvailableFlowsRequest) ProtoMessage() {}

func (x *DetectAvailableFlowsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_plugin_proto_msgTypes[50]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DetectAvailableFlowsRequest.ProtoReflect.Descriptor instead.
func (*DetectAvailableFlowsRequest) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{50}
}

func (x *DetectAvailableFlowsRequest) GetHandlerName() string {
	if x != nil {
		return x.HandlerName
	}
	return ""
...
type DetectAvailableFlowsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Flows         []*FlowAvailability    `protobuf:"bytes,1,rep,name=flows,proto3" json:"flows,omitempty"`
	Error         string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DetectAvailableFlowsResponse) Reset() {
	*x = DetectAvailableFlowsResponse{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DetectAvailableFlowsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DetectAvailableFlowsResponse) ProtoMessage() {}

func (x *DetectAvailableFlowsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_plugin_proto_msgTypes[51]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DetectAvailableFlowsResponse.ProtoReflect.Descriptor instead.
func (*DetectAvailableFlowsResponse) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{51}
}

func (x *DetectAvailableFlowsResponse) GetFlows() []*FlowAvailability {
	if x != nil {
		return x.Flows
	}
	return nil
...
func (x *DetectAvailableFlowsResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *FlowAvailability) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlowAvailability) ProtoMessage() {}

func (x *FlowAvailability) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_plugin_proto_msgTypes[52]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlowAvailability.ProtoReflect.Descriptor instead.
func (*FlowAvailability) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{52}
}

func (x *FlowAvailability) GetFlow() string {
	if x != nil {
		return x.Flow
	}
	return ""
...
func (x *FlowAvailability) GetAvailable() bool {
	if x != nil {
		return x.Available
	}
	return false
...
func (x *FlowAvailability) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *GetAuthIdentityRequest) Reset() {
	*x = GetAuthIdentityRequest{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAuthIdentityRequest) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{61}
}
...
func (x *GetAuthIdentityResponse) Reset() {
	*x = GetAuthIdentityResponse{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAuthIdentityResponse) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{62}
}
...
func (x *ListAuthHandlersRequest) Reset() {
	*x = ListAuthHandlersRequest{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListAuthHandlersRequest) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{63}
}
...
func (x *ListAuthHandlersResponse) Reset() {
	*x = ListAuthHandlersResponse{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListAuthHandlersResponse) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{64}
}
...
func (x *GetAuthTokenRequest) Reset() {
	*x = GetAuthTokenRequest{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAuthTokenRequest) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{65}
}
...
func (x *GetAuthTokenRequest) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
func (x *GetAuthTokenResponse) Reset() {
	*x = GetAuthTokenResponse{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[66]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAuthTokenResponse) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{66}
}
...
func (x *GetAuthGroupsRequest) Reset() {
	*x = GetAuthGroupsRequest{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[67]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAuthGroupsRequest) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{67}
}
...
func (x *GetAuthGroupsResponse) Reset() {
	*x = GetAuthGroupsResponse{}
	mi := &file_plugin_proto_plugin_proto_msgTypes[68]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAuthGroupsResponse) Descriptor() ([]byte, []int) {
	return file_plugin_proto_plugin_proto_rawDescGZIP(), []int{68}
}
...
const file_plugin_proto_plugin_proto_rawDesc = "" +
	"\n" +
	"\x19plugin/proto/plugin.proto\x12\x06plugin\"7\n" +
	"\x19ActivateServerModeRequest\x12\x1a\n" +
	"\bsettings\x18\x01 \x01(\fR\bsettings\"2\n" +
	"\x1aActivateServerModeResponse\x12\x14\n" +
	...
	"\x10write_operations\x18\x16 \x03(\tR\x0fwriteOperations\x12;\n" +
	"\n" +
	"operations\x18\x17 \x03(\v2\x1b.plugin.OperationDescriptorR\n" +
	"operations\x1aP\n" +
	...
	"\x10\vR\rmock_behavior\"\x87\x03\n" +
	"\x13OperationDescriptor\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\"\n" +
	"\fcapabilities\x18\x04 \x03(\tR\fcapabilities\x12\x19\n" +
	"\bis_write\x18\x05 \x01(\bR\aisWrite\x12!\n" +
	"\finput_schema\x18\x06 \x01(\fR\vinputSchema\x12#\n" +
	"\routput_schema\x18\a \x01(\fR\foutputSchema\x12+\n" +
	"\bexamples\x18\b \x03(\v2\x0f.plugin.ExampleR\bexamples\x12\x12\n" +
	"\x04tags\x18\t \x03(\tR\x04tags\x12\x1e\n" +
	"\n" +
	"deprecated\x18\n" +
	" \x01(\bR\n" +
	"deprecated\x12/\n" +
	"\x13deprecation_message\x18\v \x01(\tR\x12deprecationMessage\",\n" +
	"\x04Link\x12\x12\n" +
	...
	"\x15has_exclusive_maximum\x18\x15 \x01(\bR\x13hasExclusiveMaximum\"\x9e\x05\n" +
	...
	"\fauth_profile\x18\r \x01(\tR\vauthProfile\x12H\n" +
	"\bsettings\x18\x0e \x03(\v2,.plugin.ExecuteProviderRequest.SettingsEntryR\bsettings\x1a;\n" +
	"\rSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01\"\x87\x03\n" +
	...
	"\x10protocol_version\x18\x03 \x01(\x05R\x0fprotocolVersion\"\xc9\x01\n" +
	...
	"\x1bDetectAvailableFlowsRequest\x12!\n" +
	"\fhandler_name\x18\x01 \x01(\tR\vhandlerName\"d\n" +
	"\x1cDetectAvailableFlowsResponse\x12.\n" +
	"\x05flows\x18\x01 \x03(\v2\x18.plugin.FlowAvailabilityR\x05flows\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\"\\\n" +
	"\x10FlowAvailability\x12\x12\n" +
	"\x04flow\x18\x01 \x01(\tR\x04flow\x12\x1c\n" +
	...
	"\x0fdefault_handler\x18\x02 \x01(\tR\x0edefaultHandler\"\xc0\x01\n" +
	"\x13GetAuthTokenRequest\x12!\n" +
	"\fhandler_name\x18\x01 \x01(\tR\vhandlerName\x12\x14\n" +
	"\x05scope\x18\x02 \x01(\tR\x05scope\x121\n" +
	"\x15min_valid_for_seconds\x18\x03 \x01(\x03R\x12minValidForSeconds\x12#\n" +
	"\rforce_refresh\x18\x04 \x01(\bR\fforceRefresh\x12\x18\n" +
	"\aprofile\x18\x05 \x01(\tR\aprofile\"\xac\x01\n" +
	...
	"\x14GetAuthGroupsRequest\x12!\n" +
	"\fhandler_name\x18\x01 \x01(\tR\vhandlerName\"E\n" +
	"\x15GetAuthGroupsResponse\x12\x16\n" +
	"\x06groups\x18\x01 \x03(\tR\x06groups\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error2\xc9\x05\n" +
	"\rPluginService\x12I\n" +
	...
	"\fStopProvider\x12\x1b.plugin.StopProviderRequest\x1a\x1c.plugin.StopProviderResponse2\xe8\x04\n" +
	"\vHostService\x12@\n" +
	...
	"\fGetAuthToken\x12\x1b.plugin.GetAuthTokenRequest\x1a\x1c.plugin.GetAuthTokenResponse\x12L\n" +
	"\rGetAuthGroups\x12\x1c.plugin.GetAuthGroupsRequest\x1a\x1d.plugin.GetAuthGroupsResponse2\x8a\a\n" +
	...
	"\x0fStopAuthHandler\x12\x1e.plugin.StopAuthHandlerRequest\x1a\x1f.plugin.StopAuthHandlerResponse\x12a\n" +
	"\x14DetectAvailableFlows\x12#.plugin.DetectAvailableFlowsRequest\x1a$.plugin.DetectAvailableFlowsResponse\x12[\n" +
	"\x12ActivateServerMode\x12!.plugin.ActivateServerModeRequest\x1a\".plugin.ActivateServerModeResponseB<Z:github.com/oakwood-commons/scafctl-plugin-sdk/plugin/protob\x06proto3"
...
var file_plugin_proto_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_plugin_proto_plugin_proto_goTypes = []any{
	(Diagnostic_Severity)(0),              // 0: plugin.Diagnostic.Severity
	(*ActivateServerModeRequest)(nil),     // 1: plugin.ActivateServerModeRequest
	(*ActivateServerModeResponse)(nil),    // 2: plugin.ActivateServerModeResponse
	(*GetProvidersRequest)(nil),           // 3: plugin.GetProvidersRequest
	(*GetProvidersResponse)(nil),          // 4: plugin.GetProvidersResponse
	(*GetProviderDescriptorRequest)(nil),  // 5: plugin.GetProviderDescriptorRequest
	(*GetProviderDescriptorResponse)(nil), // 6: plugin.GetProviderDescriptorResponse
	(*ProviderDescriptor)(nil),            // 7: plugin.ProviderDescriptor
	(*OperationDescriptor)(nil),           // 8: plugin.OperationDescriptor
	(*Link)(nil),                          // 9: plugin.Link
	(*Example)(nil),                       // 10: plugin.Example
	(*Contact)(nil),                       // 11: plugin.Contact
	(*Schema)(nil),                        // 12: plugin.Schema
	(*Parameter)(nil),                     // 13: plugin.Parameter
	(*ExecuteProviderRequest)(nil),        // 14: plugin.ExecuteProviderRequest
	(*ConfigureProviderRequest)(nil),      // 15: plugin.ConfigureProviderRequest
	(*ConfigureProviderResponse)(nil),     // 16: plugin.ConfigureProviderResponse
	(*SolutionMeta)(nil),                  // 17: plugin.SolutionMeta
	(*IterationContext)(nil),              // 18: plugin.IterationContext
	(*ExecuteProviderStreamChunk)(nil),    // 19: plugin.ExecuteProviderStreamChunk
	(*Diagnostic)(nil),                    // 20: plugin.Diagnostic
	(*ExecuteProviderResponse)(nil),       // 21: plugin.ExecuteProviderResponse
	(*DescribeWhatIfRequest)(nil),         // 22: plugin.DescribeWhatIfRequest
	(*DescribeWhatIfResponse)(nil),        // 23: plugin.DescribeWhatIfResponse
	(*ExtractDependenciesRequest)(nil),    // 24: plugin.ExtractDependenciesRequest
	(*ExtractDependenciesResponse)(nil),   // 25: plugin.ExtractDependenciesResponse
	(*StopProviderRequest)(nil),           // 26: plugin.StopProviderRequest
	(*StopProviderResponse)(nil),          // 27: plugin.StopProviderResponse
	(*GetAuthHandlersRequest)(nil),        // 28: plugin.GetAuthHandlersRequest
	(*GetAuthHandlersResponse)(nil),       // 29: plugin.GetAuthHandlersResponse
	(*AuthHandlerInfo)(nil),               // 30: plugin.AuthHandlerInfo
	(*LoginRequest)(nil),                  // 31: plugin.LoginRequest
	(*LoginStreamMessage)(nil),            // 32: plugin.LoginStreamMessage
	(*DeviceCodePrompt)(nil),              // 33: plugin.DeviceCodePrompt
	(*LoginResult)(nil),                   // 34: plugin.LoginResult
	(*Claims)(nil),                        // 35: plugin.Claims
	(*LogoutRequest)(nil),                 // 36: plugin.LogoutRequest
	(*LogoutResponse)(nil),                // 37: plugin.LogoutResponse
	(*GetStatusRequest)(nil),              // 38: plugin.GetStatusRequest
	(*GetStatusResponse)(nil),             // 39: plugin.GetStatusResponse
	(*GetTokenRequest)(nil),               // 40: plugin.GetTokenRequest
	(*GetTokenResponse)(nil),              // 41: plugin.GetTokenResponse
	(*ListCachedTokensRequest)(nil),       // 42: plugin.ListCachedTokensRequest
	(*ListCachedTokensResponse)(nil),      // 43: plugin.ListCachedTokensResponse
	(*CachedTokenInfo)(nil),               // 44: plugin.CachedTokenInfo
	(*PurgeExpiredTokensRequest)(nil),     // 45: plugin.PurgeExpiredTokensRequest
	(*PurgeExpiredTokensResponse)(nil),    // 46: plugin.PurgeExpiredTokensResponse
	(*ConfigureAuthHandlerRequest)(nil),   // 47: plugin.ConfigureAuthHandlerRequest
	(*ConfigureAuthHandlerResponse)(nil),  // 48: plugin.ConfigureAuthHandlerResponse
	(*StopAuthHandlerRequest)(nil),        // 49: plugin.StopAuthHandlerRequest
	(*StopAuthHandlerResponse)(nil),       // 50: plugin.StopAuthHandlerResponse
	(*DetectAvailableFlowsRequest)(nil),   // 51: plugin.DetectAvailableFlowsRequest
	(*DetectAvailableFlowsResponse)(nil),  // 52: plugin.DetectAvailableFlowsResponse
	(*FlowAvailability)(nil),              // 53: plugin.FlowAvailability
	(*GetSecretRequest)(nil),              // 54: plugin.GetSecretRequest
	(*GetSecretResponse)(nil),             // 55: plugin.GetSecretResponse
	(*SetSecretRequest)(nil),              // 56: plugin.SetSecretRequest
	(*SetSecretResponse)(nil),             // 57: plugin.SetSecretResponse
	(*DeleteSecretRequest)(nil),           // 58: plugin.DeleteSecretRequest
	(*DeleteSecretResponse)(nil),          // 59: plugin.DeleteSecretResponse
	(*ListSecretsRequest)(nil),            // 60: plugin.ListSecretsRequest
	(*ListSecretsResponse)(nil),           // 61: plugin.ListSecretsResponse
	(*GetAuthIdentityRequest)(nil),        // 62: plugin.GetAuthIdentityRequest
	(*GetAuthIdentityResponse)(nil),       // 63: plugin.GetAuthIdentityResponse
	(*ListAuthHandlersRequest)(nil),       // 64: plugin.ListAuthHandlersRequest
	(*ListAuthHandlersResponse)(nil),      // 65: plugin.ListAuthHandlersResponse
	(*GetAuthTokenRequest)(nil),           // 66: plugin.GetAuthTokenRequest
	(*GetAuthTokenResponse)(nil),          // 67: plugin.GetAuthTokenResponse
	(*GetAuthGroupsRequest)(nil),          // 68: plugin.GetAuthGroupsRequest
	(*GetAuthGroupsResponse)(nil),         // 69: plugin.GetAuthGroupsResponse
	nil,                                   // 70: plugin.ProviderDescriptor.OutputSchemasEntry
	nil,                                   // 71: plugin.ProviderDescriptor.RawOutputSchemasEntry
	nil,                                   // 72: plugin.Schema.ParametersEntry
	nil,                                   // 73: plugin.ExecuteProviderRequest.SettingsEntry
	nil,                                   // 74: plugin.ConfigureProviderRequest.SettingsEntry
	nil,                                   // 75: plugin.ConfigureAuthHandlerRequest.SettingsEntry
}
var file_plugin_proto_plugin_proto_depIdxs = []int32{
	7,  // 0: plugin.GetProviderDescriptorResponse.descriptor:type_name -> plugin.ProviderDescriptor
	12, // 1: plugin.ProviderDescriptor.schema:type_name -> plugin.Schema
	70, // 2: plugin.ProviderDescriptor.output_schemas:type_name -> plugin.ProviderDescriptor.OutputSchemasEntry
	9,  // 3: plugin.ProviderDescriptor.links:type_name -> plugin.Link
	10, // 4: plugin.ProviderDescriptor.examples:type_name -> plugin.Example
	11, // 5: plugin.ProviderDescriptor.maintainers:type_name -> plugin.Contact
	71, // 6: plugin.ProviderDescriptor.raw_output_schemas:type_name -> plugin.ProviderDescriptor.RawOutputSchemasEntry
	8,  // 7: plugin.ProviderDescriptor.operations:type_name -> plugin.OperationDescriptor
	10, // 8: plugin.OperationDescriptor.examples:type_name -> plugin.Example
	72, // 9: plugin.Schema.parameters:type_name -> plugin.Schema.ParametersEntry
	18, // 10: plugin.ExecuteProviderRequest.iteration_context:type_name -> plugin.IterationContext
	17, // 11: plugin.ExecuteProviderRequest.solution_metadata:type_name -> plugin.SolutionMeta
	73, // 12: plugin.ExecuteProviderRequest.settings:type_name -> plugin.ExecuteProviderRequest.SettingsEntry
	74, // 13: plugin.ConfigureProviderRequest.settings:type_name -> plugin.ConfigureProviderRequest.SettingsEntry
	20, // 14: plugin.ConfigureProviderResponse.diagnostics:type_name -> plugin.Diagnostic
	21, // 15: plugin.ExecuteProviderStreamChunk.result:type_name -> plugin.ExecuteProviderResponse
	0,  // 16: plugin.Diagnostic.severity:type_name -> plugin.Diagnostic.Severity
	20, // 17: plugin.ExecuteProviderResponse.diagnostics:type_name -> plugin.Diagnostic
	20, // 18: plugin.DescribeWhatIfResponse.diagnostics:type_name -> plugin.Diagnostic
	20, // 19: plugin.ExtractDependenciesResponse.diagnostics:type_name -> plugin.Diagnostic
	30, // 20: plugin.GetAuthHandlersResponse.handlers:type_name -> plugin.AuthHandlerInfo
	33, // 21: plugin.LoginStreamMessage.device_code_prompt:type_name -> plugin.DeviceCodePrompt
	34, // 22: plugin.LoginStreamMessage.result:type_name -> plugin.LoginResult
	35, // 23: plugin.LoginResult.claims:type_name -> plugin.Claims
	35, // 24: plugin.GetStatusResponse.claims:type_name -> plugin.Claims
	44, // 25: plugin.ListCachedTokensResponse.tokens:type_name -> plugin.CachedTokenInfo
	75, // 26: plugin.ConfigureAuthHandlerRequest.settings:type_name -> plugin.ConfigureAuthHandlerRequest.SettingsEntry
	20, // 27: plugin.ConfigureAuthHandlerResponse.diagnostics:type_name -> plugin.Diagnostic
	53, // 28: plugin.DetectAvailableFlowsResponse.flows:type_name -> plugin.FlowAvailability
	35, // 29: plugin.GetAuthIdentityResponse.claims:type_name -> plugin.Claims
	12, // 30: plugin.ProviderDescriptor.OutputSchemasEntry.value:type_name -> plugin.Schema
	13, // 31: plugin.Schema.ParametersEntry.value:type_name -> plugin.Parameter
	3,  // 32: plugin.PluginService.GetProviders:input_type -> plugin.GetProvidersRequest
	5,  // 33: plugin.PluginService.GetProviderDescriptor:input_type -> plugin.GetProviderDescriptorRequest
	15, // 34: plugin.PluginService.ConfigureProvider:input_type -> plugin.ConfigureProviderRequest
	14, // 35: plugin.PluginService.ExecuteProvider:input_type -> plugin.ExecuteProviderRequest
	14, // 36: plugin.PluginService.ExecuteProviderStream:input_type -> plugin.ExecuteProviderRequest
	22, // 37: plugin.PluginService.DescribeWhatIf:input_type -> plugin.DescribeWhatIfRequest
	24, // 38: plugin.PluginService.ExtractDependencies:input_type -> plugin.ExtractDependenciesRequest
	26, // 39: plugin.PluginService.StopProvider:input_type -> plugin.StopProviderRequest
	54, // 40: plugin.HostService.GetSecret:input_type -> plugin.GetSecretRequest
	56, // 41: plugin.HostService.SetSecret:input_type -> plugin.SetSecretRequest
	58, // 42: plugin.HostService.DeleteSecret:input_type -> plugin.DeleteSecretRequest
	60, // 43: plugin.HostService.ListSecrets:input_type -> plugin.ListSecretsRequest
	62, // 44: plugin.HostService.GetAuthIdentity:input_type -> plugin.GetAuthIdentityRequest
	64, // 45: plugin.HostService.ListAuthHandlers:input_type -> plugin.ListAuthHandlersRequest
	66, // 46: plugin.HostService.GetAuthToken:input_type -> plugin.GetAuthTokenRequest
	68, // 47: plugin.HostService.GetAuthGroups:input_type -> plugin.GetAuthGroupsRequest
	28, // 48: plugin.AuthHandlerService.GetAuthHandlers:input_type -> plugin.GetAuthHandlersRequest
	47, // 49: plugin.AuthHandlerService.ConfigureAuthHandler:input_type -> plugin.ConfigureAuthHandlerRequest
	31, // 50: plugin.AuthHandlerService.Login:input_type -> plugin.LoginRequest
	36, // 51: plugin.AuthHandlerService.Logout:input_type -> plugin.LogoutRequest
	38, // 52: plugin.AuthHandlerService.GetStatus:input_type -> plugin.GetStatusRequest
	40, // 53: plugin.AuthHandlerService.GetToken:input_type -> plugin.GetTokenRequest
	42, // 54: plugin.AuthHandlerService.ListCachedTokens:input_type -> plugin.ListCachedTokensRequest
	45, // 55: plugin.AuthHandlerService.PurgeExpiredTokens:input_type -> plugin.PurgeExpiredTokensRequest
	49, // 56: plugin.AuthHandlerService.StopAuthHandler:input_type -> plugin.StopAuthHandlerRequest
	51, // 57: plugin.AuthHandlerService.DetectAvailableFlows:input_type -> plugin.DetectAvailableFlowsRequest
	1,  // 58: plugin.AuthHandlerService.ActivateServerMode:input_type -> plugin.ActivateServerModeRequest
	4,  // 59: plugin.PluginService.GetProviders:output_type -> plugin.GetProvidersResponse
	6,  // 60: plugin.PluginService.GetProviderDescriptor:output_type -> plugin.GetProviderDescriptorResponse
	16, // 61: plugin.PluginService.ConfigureProvider:output_type -> plugin.ConfigureProviderResponse
	21, // 62: plugin.PluginService.ExecuteProvider:output_type -> plugin.ExecuteProviderResponse
	19, // 63: plugin.PluginService.ExecuteProviderStream:output_type -> plugin.ExecuteProviderStreamChunk
	23, // 64: plugin.PluginService.DescribeWhatIf:output_type -> plugin.DescribeWhatIfResponse
	25, // 65: plugin.PluginService.ExtractDependencies:output_type -> plugin.ExtractDependenciesResponse
	27, // 66: plugin.PluginService.StopProvider:output_type -> plugin.StopProviderResponse
	55, // 67: plugin.HostService.GetSecret:output_type -> plugin.GetSecretResponse
	57, // 68: plugin.HostService.SetSecret:output_type -> plugin.SetSecretResponse
	59, // 69: plugin.HostService.DeleteSecret:output_type -> plugin.DeleteSecretResponse
	61, // 70: plugin.HostService.ListSecrets:output_type -> plugin.ListSecretsResponse
	63, // 71: plugin.HostService.GetAuthIdentity:output_type -> plugin.GetAuthIdentityResponse
	65, // 72: plugin.HostService.ListAuthHandlers:output_type -> plugin.ListAuthHandlersResponse
	67, // 73: plugin.HostService.GetAuthToken:output_type -> plugin.GetAuthTokenResponse
	69, // 74: plugin.HostService.GetAuthGroups:output_type -> plugin.GetAuthGroupsResponse
	29, // 75: plugin.AuthHandlerService.GetAuthHandlers:output_type -> plugin.GetAuthHandlersResponse
	48, // 76: plugin.AuthHandlerService.ConfigureAuthHandler:output_type -> plugin.ConfigureAuthHandlerResponse
	32, // 77: plugin.AuthHandlerService.Login:output_type -> plugin.LoginStreamMessage
	37, // 78: plugin.AuthHandlerService.Logout:output_type -> plugin.LogoutResponse
	39, // 79: plugin.AuthHandlerService.GetStatus:output_type -> plugin.GetStatusResponse
	41, // 80: plugin.AuthHandlerService.GetToken:output_type -> plugin.GetTokenResponse
	43, // 81: plugin.AuthHandlerService.ListCachedTokens:output_type -> plugin.ListCachedTokensResponse
	46, // 82: plugin.AuthHandlerService.PurgeExpiredTokens:output_type -> plugin.PurgeExpiredTokensResponse
	50, // 83: plugin.AuthHandlerService.StopAuthHandler:output_type -> plugin.StopAuthHandlerResponse
	52, // 84: plugin.AuthHandlerService.DetectAvailableFlows:output_type -> plugin.DetectAvailableFlowsResponse
	2,  // 85: plugin.AuthHandlerService.ActivateServerMode:output_type -> plugin.ActivateServerModeResponse
...
func file_plugin_proto_plugin_proto_init() {
	...
	file_plugin_proto_plugin_proto_msgTypes[18].OneofWrappers = []any{
		(*ExecuteProviderStreamChunk_Stdout)(nil),
		(*ExecuteProviderStreamChunk_Stderr)(nil),
		(*ExecuteProviderStreamChunk_Result)(nil),
	}
	file_plugin_proto_plugin_proto_msgTypes[31].OneofWrappers = []any{
