...
const (
	...
	AuthHandlerService_ActivateServerMode_FullMethodName   = "/plugin.AuthHandlerService/ActivateServerMode"
)
...
type AuthHandlerServiceClient interface {
	...
	// ActivateServerMode transitions the handler into server mode for token serving.
	ActivateServerMode(ctx context.Context, in *ActivateServerModeRequest, opts ...grpc.CallOption) (*ActivateServerModeResponse, error)
}
...
func (c *authHandlerServiceClient) ActivateServerMode(ctx context.Context, in *ActivateServerModeRequest, opts ...grpc.CallOption) (*ActivateServerModeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActivateServerModeResponse)
	err := c.cc.Invoke(ctx, AuthHandlerService_ActivateServerMode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthHandlerServiceServer interface {
	...
	// ActivateServerMode transitions the handler into server mode for token serving.
	ActivateServerMode(context.Context, *ActivateServerModeRequest) (*ActivateServerModeResponse, error)
...
func (UnimplementedAuthHandlerServiceServer) ActivateServerMode(context.Context, *ActivateServerModeRequest) (*ActivateServerModeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ActivateServerMode not implemented")
}
...
func _AuthHandlerService_ActivateServerMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ActivateServerModeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthHandlerServiceServer).ActivateServerMode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthHandlerService_ActivateServerMode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthHandlerServiceServer).ActivateServerMode(ctx, req.(*ActivateServerModeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthHandlerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ActivateServerMode",
			Handler:    _AuthHandlerService_ActivateServerMode_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
