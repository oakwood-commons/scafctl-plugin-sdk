---
description: "scafctl-plugin-sdk: File a GitHub issue with codebase exploration and feasibility assessment."
agent: "issue-creator"
argument-hint: "Describe the change, bug, or feature (e.g., 'Add batch validation for provider descriptors')"
---
